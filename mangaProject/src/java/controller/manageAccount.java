...
public class manageAccount extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        BanAccount  ba = new BanAccount();
        // list of id of account being ban
        List<ban> la = ba.getAllBanAccount();
        // list of account being ban
        List<account> listBan = new ArrayList<>();
        for(int i=0;i<la.size();i++){
           account acc =  a.getAccountById(la.get(i).getuID());
           listBan.add(acc);
        }
